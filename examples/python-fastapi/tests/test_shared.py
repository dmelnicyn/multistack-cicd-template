"""Unit tests for tools/shared.py utilities.

Tests for redact_secrets function and other shared utilities.
"""
...
-----END PRIVATE KEY-----"""
    ...
    def test_redacts_openssh_private_keys(self) -> None:
        """OpenSSH private key blocks should be redacted."""
        content = """-----BEGIN OPENSSH PRIVATE KEY-----

-----END OPENSSH PRIVATE KEY-----"""
        result = redact_secrets(content)
        assert "BEGIN OPENSSH PRIVATE KEY" not in result
        assert "b3BlbnNzaC1rZXktdjE" not in result
        assert "[REDACTED_OPENSSH_KEY]" in result
